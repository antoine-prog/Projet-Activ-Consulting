	...
	<main>
		...
		<section class="questionAnime">
			...
			<div class="regularAnime slider filmPropose">
				<c:forEach items="${rechercheAnime}" var="currentReco">
					<div class="card text-center cards-reco">
						...
						<div class="card-footer">
							...
							<a class="btn btn-info btn-sm my-2" href="http://localhost:8080/projet_SAJ/JsonAnimeReader?idAnime=<c:out value="${currentReco.idAnime}"/>">En savoir plus</a>
