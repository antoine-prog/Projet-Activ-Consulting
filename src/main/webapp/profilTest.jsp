...
<link rel="stylesheet" href="./css/stylesProfilTest.css">
...
<%-- <header>
  ...
  <path d="M9 22V12h6v10"></path>
					...
					</a> <a href="#"> <svg stroke="currentColor" stroke-width="2"
							fill="none" stroke-linecap="round" stroke-linejoin="round"
							viewBox="0 0 24 24">
  ...
  <circle cx="12" cy="10" r="3"></circle></svg> Explore
					</a> <a href="#"> <svg xmlns="http://www.w3.org/2000/svg"
							fill="none" stroke="currentColor" stroke-width="2"
							stroke-linecap="round" stroke-linejoin="round"
							viewBox="0 0 24 24">
  ...
  <path
								...
								fill="#6a9923"></path>
  <path d="M372.07 472.11h-272a8 8 0 010-16h272a8 8 0 010 16z"
								fill="#595959"></path></svg> Foresto
  ...
  <path
								...
								fill="#f5efca"></path>
  <path d="M27.8 1z" fill="#ecf0f1"></path>
  <path
  ...
  <path
								...
								fill="#f29c1f"></path>
  <path d="M32 12.3a3 3 0 11-3.5-2.3z" fill="#f0c419"></path>
  <path
								d="M44 18a1 1 0 010-2c.5-.1 1-.3 1.3-.7a1 1 0 011.4 1.4C46 17.4 45 18 44 18z"
								fill="#e57e25"></path>
  <circle cx="29" cy="13" fill="#393f4a" r="2"></circle>
  <path
  ...
  <g fill="#f5760f">
  <path
								d="M300.7 508.8a8.4 8.4 0 01-2-6.6 662.7 662.7 0 00-29-289.7 8.4 8.4 0 018-11H264a8.4 8.4 0 00-8 11 662.9 662.9 0 0129 289.7 8.4 8.4 0 008.4 9.5H307c-2.4 0-4.7-1-6.3-2.9z"></path>
  <path
								d="M331.2 312.2l-48.8 9.1c.9 5.6 1.7 11.1 2.4 16.7l50.6-9.5c-1.3-5.5-2.7-10.9-4.2-16.3zM288 369.2l1.1 16.7h57.2a641 641 0 00-2.6-16.7H288z"></path>
  </g>
  <path
  ...
  <g fill="#a4d64d">
  <path
								d="M327 199.3c-15.3-.3-30.3 2.1-44.7 7.2a8.4 8.4 0 00-3.3 13.7l148 154.7a8.5 8.5 0 0013.8-2.6 125.9 125.9 0 00-113.7-173z"></path>
  <path
								d="M293.3 212.1a125.9 125.9 0 00-222.8-54.3A8.5 8.5 0 0075 171l208 50.7a8.4 8.4 0 0010.2-9.7z"></path>
  </g>
  <path
  ...
  <path
								...
								fill="#ffc412"></path>
  <circle cx="290.8" cy="218.3" r="29.3" fill="#a4a09a"></circle>
  <path
								d="M299.2 239.2a29.3 29.3 0 01-24.5-45.4 29.3 29.3 0 1040.7 40.6c-4.7 3-10.2 4.8-16.2 4.8z"
								fill="#928d86"></path>
  <circle cx="316" cy="256" r="29.3" fill="#a4a09a"></circle>
  <path
								d="M324.4 281.1a29.3 29.3 0 01-17.1-53.1 29.4 29.4 0 1025.8 51.8c-2.8.9-5.7 1.3-8.7 1.3z"
								fill="#928d86"></path>
  <circle cx="261.5" cy="256" r="29.3" fill="#a4a09a"></circle>
  <path
								d="M269.9 277a29.3 29.3 0 01-24.5-45.5A29.3 29.3 0 10286 272c-4.6 3-10.2 4.9-16.1 4.9z"
								fill="#928d86"></path>
  <g fill="#ffb266">
  <circle cx="274.1" cy="473.9" r="8.4"></circle>
  <circle cx="378.9" cy="482.3" r="8.4"></circle>
  <circle cx="328.6" cy="465.6" r="8.4"></circle>
  <circle cx="223.8" cy="457.2" r="8.4"></circle>
  <circle cx="202.8" cy="482.3" r="8.4"></circle>
  <circle cx="144.2" cy="482.3" r="8.4"></circle>
  </g>
  </svg> Nature
					</a> <a href="#"><svg viewBox="0 0 511.4 511.4" width="512"
							xmlns="http://www.w3.org/2000/svg">
  <path d="M102.8 145c-47.5 0-86 38.6-86 86v29.3h168.6V145z"
								fill="#0dca71"></path>
  <path
  ...
  <path
								...
								fill="#0dca71"></path>
  <path d="M408.6 145H326v115.3h168.7v-29.2c0-47.5-38.6-86.1-86-86.1z"
								fill="#0cba68"></path>
  <path
  ...
  <g>
  <path d="M420 269.3c0-62.4-31.7-117.1-79.2-147.4l-85 147.4z"
								fill="#ebb65b"></path>
  <path d="M255.7 269.3L340.8 122c-24.8-15.8-54-25-85-25L245 160z"
								fill="#fdd278"></path>
  <path d="M91.4 269.3h164.3l-85-147.4a174.3 174.3 0 00-79.3 147.4z"
								fill="#ffc663"></path>
  <path d="M255.7 97c-31.1 0-60.2 9.1-85 25l85 147.3z" fill="#ffe7ab"></path>
  <path d="M255.7 269.3L245 384l10.7 57.7c31.1 0 60.3-9.2 85.1-25z"
								fill="#ebb65b"></path>
  <path d="M255.7 269.3l85.1 147.4c47.5-30.2 79.2-85 79.2-147.4z"
								fill="#fdd278"></path>
  <path d="M170.6 416.7c24.9 15.8 54 25 85.1 25V269.3z" fill="#ffc663"></path>
  <path d="M255.7 269.3H91.4c0 62.4 31.8 117.2 79.2 147.4z"
								fill="#ffe7ab"></path>
  <path d="M337 269.3L296.4 199h-40.7L245 266.7l10.7 73h40.7z"
								fill="#ffe5a5"></path>
  <path d="M215 198.9l-40.6 70.4 40.7 70.5h40.6V198.9z" fill="#fffaed"></path>
  </g>
  </svg> Animals </a> <a href="#"> <svg xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 512 512">
  <path
								d="M176.6 360l-51.1-24.2-26-12.3L155.1 187l35.5-8.8s-58 97.4-14 181.9z"
								fill="#f8b40e"></path>
  <path d="M488.8 330.5v-62.4c0-5-4-9-9-9h-25.7c-5 0-9 4-9 9v22.5"
								fill="#f2171c"></path>
  <path d="M464.7 330.5v-71.3H454c-5 0-9 4-9 8.9v22.5" fill="#d8131e"></path>
  <path
  ...
  <path
								...
								fill="#dd9b0a"></path>
  <path fill="#f8b40e" d="M356.5 423H143.1v-36h183.8"></path>
  <circle cx="415.1" cy="423" r="78.2" fill="#2c4046"></circle>
  <path fill="#dd9b0a" d="M167.5 187l-64.9 173.8-3-37.3L155 187z"></path>
  <circle cx="415.1" cy="423" r="42.8" fill="#9aa7b8"></circle>
  <circle cx="99.5" cy="423" r="78.2" fill="#2c4046"></circle>
  <circle cx="99.5" cy="423" r="42.8" fill="#9aa7b8"></circle>
  <path
  ...
  <path
								...
								fill="#dd9b0a"></path>
  <path d="M199 423a99.5 99.5 0 00-199 0h199z" fill="#f8b40e"></path>
  <path d="M116 324.9A99.5 99.5 0 000 423h33a99.5 99.5 0 0183-98.1z"
								fill="#dd9b0a"></path>
  <path
  ...
  <path
								...
								fill="#a0d9f2"></path>
  <path d="M146.1 170.8h-24v8.1c0 4.5 3.6 8.1 8 8.1h16v-16.2z"
								fill="#84bed3"></path>
  <path
								d="M394.9 222.4l-153 10.8a33.6 33.6 0 00-31.2 33.5h213v-17.4a27 27 0 00-28.8-26.9z"
								fill="#444d56"></path>
  <path fill="#d3d3d3" d="M183.9 65.5h15.7v77.2h-15.7z"></path>
  <g fill="#dd9b0a">
  <path
								d="M452.2 337.4h-76.6a7.9 7.9 0 010-15.8h76.6a7.9 7.9 0 010 15.8zM432.2 362.7h-56.6a7.9 7.9 0 010-15.7h56.6a7.9 7.9 0 010 15.7zM412.1 387.8h-36.5a7.9 7.9 0 010-15.7H412a7.9 7.9 0 010 15.7z"></path>
  </g>
  <circle cx="191.8" cy="147.2" r="23.1" fill="#444d56"></circle>
  <path
  ...
  <path
								...
								fill="#fb8801"></path>
  <circle cx="438.8" cy="403.5" fill="#60b7ff" r="23.4"></circle>
  <path
  ...
  <path d="M24 511l321-137-101-100-100-101L7 494c-4 11 6 21 17 17z"
								fill="#fe7d43"></path>
  <path d="M345 374L24 511c-11 4-21-6-17-17 3 1 5 0 8-1l315-134z"
								fill="#fd6930"></path>
  <g fill="#7acaa6">
  <path
								d="M47 401l95 60-54 22-60-37zM84 315l162 101-54 23-128-80zM120 229l210 131 15 14-49 21-195-122z"></path>
  </g>
  <g fill="#57be92">
  <path
								d="M142 461l-54 22-20-12 54-23zM246 416l-54 23-20-13 54-23zM345 374l-49 21-20-13 53-23 1 1z"></path>
  </g>
  <path
  ...
  <path
			...
			<a href="https://twitter.com/AysnrTrkk" class="follow-me"
				target="_blank"> <span class="follow-text"> <svg
...
<!-- 			<div class="search-bar">
			...
			<div class="main-container">
				<div class="profile">
					...
					<div class="profile-menu">
						<a class="profile-menu-link active">Timeline</a> <a
							class="profile-menu-link">About</a> <a class="profile-menu-link">Friends</a>
						<a class="profile-menu-link">Photos</a> <a
							class="profile-menu-link">More</a>
					</div>
				</div>
				<div class="timeline">
					...
					<div class="timeline-right">
						<div class="status box">
							<div class="status-menu">
								<a class="status-menu-item active" href="#">Status</a> <a
									class="status-menu-item" href="#">Photos</a> <a
									class="status-menu-item" href="#">Videos</a>
							</div>
							<div class="status-main">
								<img
									src="https://images.genius.com/2326b69829d58232a2521f09333da1b3.1000x1000x1.jpg"
									class="status-img">
								<textarea class="status-textarea"
  ...
  <path
								...
								</a> <a href="#" class="status-action"> <svg
  ...
  <path
						...
						<div class="album box">
							...
							<div class="album-actions">
								<a href="#" class="album-action"> <svg stroke="currentColor"
  ...
  <path
								...
								</a> <a href="#" class="album-action"> <svg
										stroke="currentColor" stroke-width="2" fill="none"
										stroke-linecap="round" stroke-linejoin="round"
  ...
  <path d="M22 6l-10 7L2 6"></path>
				...
				<button class="account-button">
					<svg stroke="currentColor" stroke-width="2" fill="none"
						...
						viewBox="0 0 24 24">
  <path
							d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 01-3.46 0"></path>
  </svg>
				</button>
				<span class="account-user">Quan Ha <img
					src="https://images.genius.com/2326b69829d58232a2521f09333da1b3.1000x1000x1.jpg"
					alt="" class="account-profile"> <span>▼</span>
				</span>
			</div>
...
<!-- 		<div class="overlay" @click="rightSide = false; leftSide = false"
	...
	<script
		src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v1.9.4/dist/alpine.js"></script>
