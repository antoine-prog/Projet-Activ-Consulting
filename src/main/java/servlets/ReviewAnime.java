...
public class ReviewAnime extends HttpServlet {
...
//			monAnime get Anime vu par lidAnime (BDD=)
//			monanime.add(mareview);
//			utilisateur.add(ma review)
			...
			int id = RequeteBDD.getAnimeId(idUtilisateur, idAnime);
			AnimeSaisonVu anime = session.get(AnimeSaisonVu.class, id);
			
			AnimeReview maReview = new AnimeReview(idAnime,note,commentaire);
			
			user.addAnimeReview(maReview);
			anime.addAnimeReview(maReview);
			...
			//Mis a jour des données recupérées
